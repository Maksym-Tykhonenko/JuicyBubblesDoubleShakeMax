...
import JuicyBubblesDoubleShakeOnboarding from './JuicyBubblesDoubleShakeSrc/JuicyBubblesDoubleShakeScreens/JuicyBubblesDoubleShakeOnboarding';
import JuicyBubblesDoubleShakeLoading from './JuicyBubblesDoubleShakeSrc/JuicyBubblesDoubleShakeScreens/JuicyBubblesDoubleShakeLoading';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import JuicyBubblesDoubleShakeMainLocalizator from './JuicyBubblesDoubleShakeSrc/JuicyBubblesDoubleShakeScreens/JuicyBubblesDoubleShakeMainLocalizator';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import { NavigationContainer } from '@react-navigation/native';
const Stack = createNativeStackNavigator();
import ProductScreen from './JuicyBubblesDoubleShakeSrc/JuicyBubblesDoubleShakeScreens/ProductScreen';
// libs
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://modern-flow-max.space/`;
  const URL_IDENTIFAIRE = `wt2XWUPH`;
  ...
  OneSignal.initialize('f6b1a04b-9046-4ae5-ae90-bfc46059104e');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator initialRouteName={'JuicyBubblesDoubleShakeOnboarding'}>
        <Stack.Screen
          name="JuicyBubblesDoubleShakeMainLocalizator"
          component={JuicyBubblesDoubleShakeMainLocalizator}
          options={{
        ...
        <Stack.Screen
          name="JuicyBubblesDoubleShakeLoading"
          component={JuicyBubblesDoubleShakeLoading}
          options={{ headerShown: false }}
        />

        <Stack.Screen
          name="JuicyBubblesDoubleShakeOnboarding"
          component={JuicyBubblesDoubleShakeOnboarding}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    );
...
const JuicyBubblesDoubleShakeStack = () => {
  return (
...
export default JuicyBubblesDoubleShakeStack;
